# Build script : APK WebView Anime Tracker VF (sans Gradle)
# Prerequis :
...
# Sortie : anime-tracker-vf.apk a la racine du repo
# Note : build-tools 34 plante (NPE d8/R8) avec les classfiles de JDK 25 — utiliser 35+.
...
Get-Item "$repo\anime-tracker-vf.apk" | Select-Object Name, Length
Write-Host "BUILD OK"
